      ...
      <div className='p-4'>
        ...
        <div className='flex items-center justify-between border-t border-orange-100 pt-3'>
          <div className='flex space-x-3'>
            <button title='View Activity' className='p-2 rounded-full bg-orange-400/30 text-orange-500 cursor-pointer hover:text-white hover:bg-orange-400 transition-colors duration-200'>
              <FaEye className='text-sm' />
            </button>
            <button title='Edit Activity' className='p-2 rounded-full bg-sky-400/30 text-sky-500 cursor-pointer hover:bg-sky-400 hover:text-white transition-colors duration-200'>
              <FaEdit className='text-sm' />
            </button>
            <button title='Delete Activity' className='p-2 rounded-full bg-red-400/30 cursor-pointer text-red-500 hover:bg-red-500 hover:text-white transition-colors duration-200'>
